            ...
            <div style={{ display: "flex", justifyContent: "space-around" }}>
                <div style={{ display: "flex", flexDirection: "column" }}>
                    <div style={{ display: "flex", flexDirection: "row", justifyContent: "space-between" }}>
                        ...
                        <Button variant="outlined" style={{ backgroundColor: 'black', color: 'white', position: "absolute", right: 50, top: 100 }} onClick={() => navigate("/")}>GO TO MAIN PAGE</Button>
                ...
                <div style={{ marginLeft: 40, display: "flex", flexDirection: "column" }}>
                    <span style={{ marginTop: 20 }}>Select date for the event</span>
                    ...
                    }} variant="outlined" style={{ backgroundColor: '#2196f3', color: 'white' }}>ADD EVENT</Button>
                </div>
